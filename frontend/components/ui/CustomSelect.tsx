      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className={`absolute left-0 right-0 z-[var(--z-dropdown)] max-h-60 overflow-y-auto border border-border bg-surface shadow-[0_8px_24px_rgba(0,0,0,0.4),0_2px_8px_rgba(0,0,0,0.3)] ${
